...
import { removeCenterClassFromNorthMap, addCenterClassForNorthMap, removeActiveButtonClass, removeVisibleClassFromSzadekStreet } from './src/classListHelpers.js';
    ...
    elements.buildingOptions.forEach(option => {
        if(option.selected) {
            elements.buildings.forEach(building => {
                ...
                // elements.mapaSzadek.classList.remove('center');//czy tu też Wygwizdów usuwać????
                // elements.streetsSzadek.classList.remove('center');//czy tu też Wygwizdów usuwać????
