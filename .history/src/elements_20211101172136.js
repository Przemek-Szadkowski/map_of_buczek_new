...
export const select_buildings = getElement(constants.SELECT_BUILDINGS_SELECTOR);
export const building_options = getElementsInParentsElement(select_buildings, constants.OPTIONS_SELECTOR);
