...
export const building_options = getElementsInParentsElement(selectBuildings, constants.OPTIONS_SELECTOR);
export const aside = getElement(constants.ASIDE_BUILDINGS_SELECTOR);
export const select_buildings_aside = document.querySelector('.select_buildings_aside');
